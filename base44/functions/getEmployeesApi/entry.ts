...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const data = paginated.map(emp => ({
      ...
      nombre_completo: [emp.nombre, emp.apellidos].filter(Boolean).join(' ') || emp.nombre || null,
      dni: emp.dni || null,
      sexo: emp.sexo || null,
      nacionalidad: emp.nacionalidad || null,
      fecha_nacimiento: emp.fecha_nacimiento || null,
      email: emp.email || null,
      telefono: emp.telefono_movil || null,
      ...
      num_horas_jornada: emp.num_horas_jornada ?? null,
      turno: emp.tipo_turno || null,
      equipo: emp.equipo || null,
      team_key: emp.team_key || null,
      horario_manana_inicio: emp.horario_manana_inicio || null,
      horario_manana_fin: emp.horario_manana_fin || null,
      horario_tarde_inicio: emp.horario_tarde_inicio || null,
      horario_tarde_fin: emp.horario_tarde_fin || null,
      fecha_alta: emp.fecha_alta || null,
      fecha_baja: emp.fecha_baja || null,
      estado_empleado: emp.estado_empleado || null,
      activo: emp.estado_empleado === 'Alta',
      pin: emp.pin ?? null,
