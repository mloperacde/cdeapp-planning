            ...
            <Table>
              ...
              <TableBody>
                {articles.map((article) => {
                  ...
                  const processName = processes.find(p => p.id === article.process_id)?.nombre || "-";
        ...
        <Dialog open={true} onOpenChange={() => { setShowForm(false); setEditingArticle(null); }}>
          <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label>Proceso Predeterminado</Label>
                <Select name="process_id" defaultValue={editingArticle?.process_id || ""}>
                   <SelectTrigger>
