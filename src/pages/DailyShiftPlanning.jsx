                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] text-slate-500 dark:text-slate-400 hidden sm:block">
                            Resumen de máquinas con órdenes asignadas y gestión de personal
                        </p>
                    </div>
                </div>
                <div className="flex items-center gap-2">
                     <Button onClick={() => saveMutation.mutate()} size="sm" className="h-8 gap-2 bg-green-600 hover:bg-green-700 text-white">
                        <CheckCircle2 className="w-4 h-4" />
                        <span className="hidden sm:inline">Confirmar Planificación</span>
                    </Button>
                </div>
            </div>
