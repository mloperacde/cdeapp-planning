...
import { Settings, Users, Calendar, FileText, Shield, Bell, Wrench, DollarSign, Award, MessageSquare, Package, ArrowLeft, UserCog, FolderOpen, Activity, Database, Palette, Factory, Gavel, Building2, GitBranch, Globe } from "lucide-react";
  ...
  const configModules = {
    ...
    maestras: {
      ...
      modules: [
        ...
        {
          title: "API de Empleados (cdeapp)",
          description: "Endpoint seguro para sincronizar empleados con cdeapp.es",
          icon: Globe,
          url: "/EmployeesApiConfig",
          color: "indigo"
        }
      ]
    },
