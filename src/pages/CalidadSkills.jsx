...
export default function CalidadSkills() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 mt-1">
            Gestión de competencias del departamento de Calidad.
          </p>
        </div>

        <EmployeeSkillsMatrix defaultDepartment="CALIDAD" fixedDepartment={true} />
      </div>
    </div>
  );
}
