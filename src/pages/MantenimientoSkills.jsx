...
export default function MantenimientoSkills() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 mt-1">
            Gestión de competencias del área de Mantenimiento.
          </p>
        </div>

        <EmployeeSkillsMatrix defaultDepartment="MANTENIMIENTO" fixedDepartment={true} />
      </div>
    </div>
  );
}
