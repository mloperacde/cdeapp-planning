...
export default function FabricacionSkills() {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-slate-900 flex items-center gap-3">
            ...
            Habilidades Fabricación
          </h1>
          <p className="text-slate-600 mt-1">
            Gestión de habilidades del personal de Fabricación.
          </p>
        </div>

        <EmployeeSkillsMatrix defaultDepartment="FABRICACION" fixedDepartment={true} />
      </div>
    </div>
  );
}
