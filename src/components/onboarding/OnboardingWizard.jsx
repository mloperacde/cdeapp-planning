...
export default function OnboardingWizard({ onboarding, onClose }) {
  ...
  const [formData, setFormData] = useState({
    ...
    documentos_pendientes: [
      { nombre: "Contrato firmado", requerido: true, recibido: false, archivo_url: null },
      { nombre: "DNI/NIE", requerido: true, recibido: false, archivo_url: null },
      { nombre: "Número Seguridad Social", requerido: true, recibido: false, archivo_url: null },
      { nombre: "Título académico", requerido: false, recibido: false, archivo_url: null },
      { nombre: "Certificado delitos sexuales", requerido: false, recibido: false, archivo_url: null },
    ],
    recursos_asignados: {
  ...
  const handleAssignLocker = async () => {
    ...
    try {
      // Verificar si ya tiene taquilla
      ...
      // Si no tiene, crear asignación básica
      if (!existing) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="border border-slate-200 rounded-lg p-6 bg-white">
            ...
            {currentStep === 3 && (
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-slate-900">Paso 3: Documentos</h3>
            ...
            {currentStep === 6 && (
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-slate-50 rounded-lg">
                    <div>
                      <span className="text-sm font-medium">Formación en PRL</span>
                      <p className="text-xs text-slate-600">Prevención de Riesgos Laborales</p>
                    </div>
                    <Checkbox
                      checked={formData.recursos_asignados.formacion_seguridad}
                      onCheckedChange={(checked) =>
                        setFormData({
                          ...formData,
                          recursos_asignados: {
                            ...formData.recursos_asignados,
                            formacion_seguridad: checked,
                          },
                        })
                      }
                    />
