                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 ml-2">
                      <span className="text-[11px] text-slate-500">
                        <span className="font-semibold text-emerald-600">{deptTotals.present}</span>
                        <span className="text-slate-400">/{deptTotals.expected}</span>
                      </span>
                      {deptTotals.absent > 0 && (
                        <span className="text-[10px] bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400 px-1.5 rounded-full font-medium">
                          -{deptTotals.absent}
                        </span>
                      )}
                      {deptTotals.predicted > 0 && (
                        <span className="text-[10px] bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400 px-1.5 rounded-full font-medium">
