...
export default function MaintenanceWorkOrderPDF({ maintenance, machine, employees, maintenanceType }) {
  ...
  return (
    <div className="bg-white p-8 max-w-[210mm] mx-auto" style={{ fontFamily: 'Arial, sans-serif' }}>
        ...
        <div className="flex justify-between items-start mb-4">
          <div className="flex-1">
            ...
            <p className="text-lg text-blue-700">
              OT-{maintenance.id?.substring(0, 8).toUpperCase()}
            </p>
          </div>
        ...
        <div className="p-4 grid grid-cols-2 gap-4">
          <div className="space-y-2">
            <div>
              ...
              <div className="font-bold text-lg">{getMachineName(maintenance.machine_id)}</div>
            </div>
            <div>
              <span className="text-sm text-slate-600">Código:</span>
              <div className="font-bold">{getMachineCode(maintenance.machine_id)}</div>
            </div>
            <div>
          ...
          <div className="space-y-2">
            <div>
              ...
              <div className="font-bold">{machine?.marca} {machine?.modelo}</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="font-bold">{machine?.estado}</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="border-2 border-slate-300 mb-6">
        ...
        <div className="p-4 grid grid-cols-2 gap-4">
          <div>
            ...
            <div className="font-bold">{maintenance.tipo}</div>
          </div>
          <div>
      ...
      {/* Tareas y Subtareas con Checkboxes */}
            ...
            <div className="col-span-2">
              <div className="bg-blue-50 border border-blue-200 rounded p-3">
                <span className="text-sm text-blue-900 font-semibold">
                  Duración Total del Trabajo: {maintenance.duracion_real.toFixed(2)} horas
                </span>
              </div>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="border border-slate-300 p-4">
              ...
              {maintenance.firma_tecnico ? (
                <img src={maintenance.firma_tecnico} alt="Firma Técnico" className="border border-slate-300 h-24 w-full object-contain bg-white" />
              ) : (
            ...
            <div className="border border-slate-300 p-4">
              ...
              {maintenance.firma_revisado ? (
                <img src={maintenance.firma_revisado} alt="Firma Supervisor" className="border border-slate-300 h-24 w-full object-contain bg-white" />
              ) : (
                <div className="border-2 border-dashed border-slate-300 h-24 flex items-center justify-center text-slate-400">
                  Firma Pendiente
                </div>
            ...
            <div className="border border-slate-300 p-4">
              ...
              {maintenance.firma_verificado ? (
                <img src={maintenance.firma_verificado} alt="Firma Verificador" className="border border-slate-300 h-24 w-full object-contain bg-white" />
              ) : (
                <div className="border-2 border-dashed border-slate-300 h-24 flex items-center justify-center text-slate-400">
                  Firma Pendiente
                </div>
      ...
      <div className="border-t-4 border-blue-900 pt-4 mt-8 text-center text-xs text-slate-500">
        ...
        <p className="mt-2 text-slate-400">
          Código OT: {maintenance.id} | Sistema de Gestión de Mantenimiento
        </p>
      </div>
